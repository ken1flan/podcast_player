...
void _sampleModelAttach(
    IsarCollection<dynamic> col, Id id, SampleModel object) {
  object.id = id;
}
...
extension SampleModelQueryWhere
  ...
  QueryBuilder<SampleModel, SampleModel, QAfterWhereClause> idGreaterThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SampleModel, SampleModel, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
